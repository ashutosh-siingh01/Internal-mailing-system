...
<tr bgcolor="#FFCC00"><td colspan="3" align="center"><h1>Mail Detail</h1></td></tr>

<?php
if(isset($_REQUEST['id']))
{
$mid=$_REQUEST['id'];
$sql="Select * from mailtb where mid='$mid' and delto='n'";
...
echo "<td></td>";
echo "<td></td>";
echo "<td><input type='submit' id='replybtn' name='replybtn' value='Reply' /> &nbsp; <input type='submit' id='forwardbtn' name='forwardbtn' value='Forward' />&nbsp; <input type='submit' id='deletebtn' name='deletebtn' value='Delete' />&nbsp;<input type='submit' id='cancelbtn' name='cancelbtn' value='Cancel' /></td>";
echo "</tr>";
...
{
$mid=$_REQUEST['id'];
echo "<script>window.location='Reply.php?id=$mid'</script>";
}
else if(isset($_POST['deletebtn']))
{
$mid=$_REQUEST['id'];
$sql="Update mailtb set delto='y' where mid='$mid'";
$result=mysqli_query($conn,$sql);
if($result){
